...
namespace BankOfItaly.ExchangeRate.Client
{
    ...
    public interface IRestService
    {
        ...
        /// <returns></returns>
        CurrenciesResponse GetCurrencies(Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <returns></returns>
        Task<CurrenciesResponse> GetCurrenciesAsync(Language language = null);
        ...
        /// <returns></returns>
        LatestRatesResponse GetLatestRates(Language language = null);
        ...
        /// <param name="language">Stringa identificativa della lingua in cui si desidera ottenere i dati: può valere  “it” o “en” case insensitive. Se il parametro non viene specificato, o valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <returns></returns>
        Task<LatestRatesResponse> GetLatestRatesAsync(Language language = null);
        ...
        /// <param name="language">Stringa identificativa della lingua in cui si desidera ottenere i dati: può valere  “it” o “en” case insensitive. Se il parametro non viene specificato, o valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        void DownloadLatestRatesFile(FileFormat fileFormat, string outputFilePath, Language language = null);
        ...
        /// <param name="outputFilePath">Percorso del file in output</param>
        /// <param name="language">Stringa identificativa della lingua in cui si desidera ottenere i dati: può valere  “it” o “en” case insensitive. Se il parametro non viene specificato, o valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        Task DownloadLatestRatesFileAsync(FileFormat fileFormat, string outputFilePath, Language language = null);
        ...
        /// <returns></returns>
        RatesResponse GetDailyRates(DateTime referenceDate, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore. </param>
        /// <returns></returns>
        Task<RatesResponse> GetDailyRatesAsync(DateTime referenceDate, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore. </param>
        void DownloadDailyRatesFile(FileFormat fileFormat, string outputFilePath, DateTime referenceDate, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore. </param>
        /// <returns></returns>
        Task DownloadDailyRatesFileAsync(FileFormat fileFormat, string outputFilePath, DateTime referenceDate, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        #endregion
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        RatesResponse GetMonthlyAverageRates(int month, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        Task<RatesResponse> GetMonthlyAverageRatesAsync(int month, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        void DownloadMonthlyAverageRatesFile(FileFormat fileFormat, string outputFilePath, int month, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO (case insensitive) della valuta per cui si richiede  la quotazione. Nel caso di più valute il parametro sarà ripetuto.  Se il parametro  non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati. Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.  Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        Task DownloadMonthlyAverageRatesFileAsync(FileFormat fileFormat, string outputFilePath, int month, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        #endregion
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO(case insensitive) della valuta per cui si richiede  la quotazione.Nel caso di più valute il parametro sarà ripetuto.  Se il parametro non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati.Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        RatesResponse GetAnnualAverageRates(int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO(case insensitive) della valuta per cui si richiede  la quotazione.Nel caso di più valute il parametro sarà ripetuto.  Se il parametro non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati.Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        Task<RatesResponse> GetAnnualAverageRatesAsync(int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <param name="baseCurrencyIsoCode">Codice ISO(case insensitive) della valuta per cui si richiede  la quotazione.Nel caso di più valute il parametro sarà ripetuto.  Se il parametro non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati.Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        void DownloadAnnualAverageRatesFile(FileFormat fileFormat, string outputFilePath, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        ...
        /// <param name="baseCurrencyIsoCode">Codice ISO(case insensitive) della valuta per cui si richiede  la quotazione.Nel caso di più valute il parametro sarà ripetuto.  Se il parametro non viene passato, si intendono tutte le valute per cui è disponibile la quotazione nella data richiesta. Codici ISO inesistenti verranno scartati.Se tutti i codici ISO inseriti sono inesistenti, verrà restituita una lista vuota.Se il parametro è specificato in un formato errato, il servizio restituirà un messaggio di errore</param>
        /// <returns></returns>
        Task DownloadAnnualAverageRatesFileAsync(FileFormat fileFormat, string outputFilePath, int year, string currencyIsoCode, Language language = null, string[] baseCurrencyIsoCode = null);
        #endregion
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default</param>
        /// <returns></returns>
        RatesResponse GetDailyTimeSeries(DateTime startDate, DateTime endDate, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default</param>
        /// <returns></returns>
        Task<RatesResponse> GetDailyTimeSeriesAsync(DateTime startDate, DateTime endDate, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="currencyIsoCode">Codice ISO (case insensitive) della valuta "contro" cui si vuole la quotazione. Può valere “EUR”, “USD”, “ITL”. Se il parametro non è specificato, o è specificato un valore diverso da quelli validi, il servizio restituirà un messaggio di errore.</param>
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default</param>
        void DownloadDailyTimeSeriesFile(FileFormat fileFormat, string outputFilePath, DateTime startDate, DateTime endDate, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default</param>
        /// <returns></returns>
        Task DownloadDailyTimeSeriesFileAsync(FileFormat fileFormat, string outputFilePath, DateTime startDate, DateTime endDate, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        /// <returns></returns>
        RatesResponse GetMonthlyTimeSeries(int startMonth, int startYear, int endMonth, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        /// <returns></returns>
        Task<RatesResponse> GetMonthlyTimeSeriesAsync(int startMonth, int startYear, int endMonth, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="currencyIsoCode">Codice ISO (case insensitive) della valuta "contro" cui si vuole la quotazione. Può valere “EUR”, “USD”, “ITL”. Se il parametro non è specificato, o è specificato un valore diverso da quelli validi, il servizio restituirà un messaggio di errore.</param>
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        void DownloadMonthlyTimeSeriesFile(FileFormat fileFormat, string outputFilePath, int startMonth, int startYear, int endMonth, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default.</param>
        /// <returns></returns>
        Task DownloadMonthlyTimeSeriesFileAsync(FileFormat fileFormat, string outputFilePath, int startMonth, int startYear, int endMonth, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        #endregion
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <returns></returns>
        RatesResponse GetAnnualTimeSeries(int startYear, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <returns></returns>
        Task<RatesResponse> GetAnnualTimeSeriesAsync(int startYear, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="currencyIsoCode">Codice ISO (case insensitive) della valuta "contro" cui si vuole la quotazione. Può valere “EUR”, “USD”, “ITL”. Se il parametro non è specificato, o è specificato un valore diverso da quelli validi, il servizio restituirà un messaggio di errore. </param>
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        void DownloadAnnualTimeSeriesFile(FileFormat fileFormat, string outputFilePath, int startYear, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
        ...
        /// <param name="language">Lingua in cui si desidera ottenere i dati: può valere  “it” o “en” (case insensitive). Se il parametro non viene specificato, o viene valorizzato in modo errato, i risultati saranno forniti nella lingua di default. </param>
        /// <returns></returns>
        Task DownloadAnnualTimeSeriesFileAsync(FileFormat fileFormat, string outputFilePath, int startYear, int endYear, string baseCurrencyIsoCode, string currencyIsoCode, Language language = null);
